...
export class HomeComponent {
  ...
  //temp
  bannerImage = 'https://image.freepik.com/free-vector/vector-cartoon-illustration-traditional-set-fast-food-meal_1441-331.jpg';
  promoText = '$0 delivery for 30 days! 🎉';
  promoSubText = '$0 delivery fee for orders over $10 for 30 days';
  restaurantIcon = 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/237/hamburger_1f354.png';
